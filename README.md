...
## Pre-trained
We provide our [pre-trained model file](https://github.com/yaoodng7/PEMR/releases/download/pre-trained/pre-trained_model.ckpt) obtained by pre-training for 300 epochs.
